-- Sistema de Tutorías · Migración 002
-- Acceso administrativo y recuperación segura.
...
comment on column public.app_users.recovery_code_hash is
  'Hash bcrypt de la clave de recuperación. Nunca almacena la clave original.';
